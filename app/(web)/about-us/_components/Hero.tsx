...
export function AboutHero() {
  return (
    <section
      className="w-full overflow-hidden flex items-center h-[600px] bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/image/aboutbg.jpg')" }}
    >
      <div className="container mx-auto px-4 sm:px-0 lg:px-8 py-12 sm:py-20 lg:py-[100px]">
        
        {/* FIXED responsive flex */}
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-10">

          {/* Left Content */}
          <div className="flex flex-col space-y-6 lg:space-y-8">
            <div className="space-y-4">
              <h1 className="text-3xl sm:text-[36px] lg:text-[40px] font-semibold text-[#000000] leading-tight">
                We Make Buying Cars A Joy
              </h1>
            ...
            <div className="pt-8 lg:pt-[191px]">
              <Button className="w-fit bg-[#DC2033] hover:bg-red-700 text-white text-base sm:text-lg px-6 sm:px-8 h-[44px] rounded-md flex items-center gap-2 shadow-lg">
                Learn more about our website
                <ChevronDown className="w-5 h-5" />
              </Button>
