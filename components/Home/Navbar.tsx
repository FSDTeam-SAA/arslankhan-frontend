      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/main">
              <Button className="bg-red-600 hover:bg-red-700 text-[24px] text-white h-[49px] px-5 rounded-[8px]">
                Register
              </Button>
            </Link>
          </div>
                ...
                <div className="flex flex-col gap-4 mt-8">
                  {navItems.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        className={`
                          text-xl font-medium pb-2 border-b transition-colors
                          ${
                            active
                  ...
                  <div className="flex flex-col gap-3 pt-6">
                    <Link href="/sign-in">
                      <Button
                        variant="outline"
                        className="w-full text-[#14406E] border-[#14406E]"
                      >
                        Sign in
                      </Button>
                    </Link>
